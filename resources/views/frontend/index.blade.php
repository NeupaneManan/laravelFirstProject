...
<script type="{{asset('frontend/text/javascript')}}" src="js/cufon-yui.js"></script>
<script type="{{asset('frontend/text/javascript')}}" src="js/arial.js"></script>
<script type="{{asset('frontend/text/javascript')}}" src="js/cuf_run.js"></script>
</head>
<body>
<div class="main">
  <div class="header">
    ...
    <div class="content_resize">
     ...
     @foreach ($products as $p )
        <div class="article">
            ...
            <div class="clr"></div>
            <p>{{$p->description}}</p>
            <img src="{{ asset('product/' . $p->image) }}" width="613" height="179" alt="" />
            <div class="clr"></div>
        </div>
        @endforeach
